...
`;const Ee=t=>{const{big:e=!1,direction:r,reverse:a=!1,...o}=t,s=(0,n.useMemo)((()=>function(t,e,r){switch(r){case"bottom-left":return e?be:Qt;case"bottom-right":return e?xe:te;case"down":return t?e?ke:re:e?we:ee;case"left":return t?e?Ce:ne:e?$e:ae;case"right":return t?e?Oe:se:e?Se:oe;case"top-left":return e?Ae:ie;case"top-right":return e?_e:ce;case"up":return t?e?Ne:fe:e?ze:le;default:return e?ve:Kt}}(e,a,r)),[e,r,a]);return Yt(pe,{keyframes:s,...o})};Xt`
  from {
...
`;const Te=t=>{const{direction:e,reverse:r=!1,...a}=t,o=(0,n.useMemo)((()=>function(t,e){switch(e){case"down":return t?je:Ve;case"right":return t?Ie:Ye;case"up":return t?Re:Pe;default:return t?Xe:Me}}(r,e)),[e,r]);return Yt(pe,{keyframes:o,...a})};Xt`
  from {
    opacity: 0;
    transform: scale3d(0.3, 0.3, 0.3);
  }
...
`}}]);
//# sourceMappingURL=703.4221e736.chunk.js.map